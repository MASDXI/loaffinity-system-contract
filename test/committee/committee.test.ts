...
describe("Committee System Contract", function () {
    ...
    describe("Unit test", function () {
      ...
      it("function: grantProposer()", async function () {
        await expect(fixture.committee.connect(committee1).grantProposer(proposer1.address))
    ...
    it("function: revokeProposer()", async function () {
      ...
      await fixture.committee.connect(admin).revokeProposer(proposer1.address)
      expect(await fixture.committee.isProposer(proposer1.address)).to.equal(false);
    });

    it("function: revokeProposer() fail", async function () {
      await fixture.committee.connect(admin).grantProposer(proposer1.address)
      await expect(fixture.committee.connect(committee1).revokeProposer(proposer1.address))
        .to.revertedWith("committee: onlyAdmin can call")
    });
    ...
    it("function: grantProposer()", async function () {
      await fixture.committee.connect(admin).grantProposer(proposer1.address)
      await expect(fixture.committee.connect(admin).grantProposer(proposer1.address))
        .to.revertedWith("committee: grant exist proposer address");
    });

    it("function: revokeProposer()", async function () {
      await expect(fixture.committee.connect(admin).revokeProposer(proposer1.address))
